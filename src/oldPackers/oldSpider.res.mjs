...
function OldSpider$SpiderRules$StandardBoard(props) {
...
var StandardBoard = {
  make: OldSpider$SpiderRules$StandardBoard
};

function OldSpider$SpiderRules$AllCards(props) {
...
var AllCards = {
  make: OldSpider$SpiderRules$AllCards
};
...
function OldSpider$Scorpion$Board(props) {
  var setRef = props.setRef;
  return JsxRuntime.jsxs(React.Fragment, {
              children: [
                JsxRuntime.jsxs("div", {
