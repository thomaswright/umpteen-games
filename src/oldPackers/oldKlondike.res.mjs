...
function OldKlondike$GameRules$Board(props) {
...
var Board = {
  make: OldKlondike$GameRules$Board
};

function OldKlondike$GameRules$AllCards(props) {
...
var AllCards = {
  make: OldKlondike$GameRules$AllCards
};
