...
function OldFreeCell$FreeCellRules$AllCards(props) {
...
var AllCards = {
  make: OldFreeCell$FreeCellRules$AllCards
};

function OldFreeCell$FreeCellRules$StandardBoard(props) {
  var setRef = props.setRef;
...
var StandardBoard = {
  make: OldFreeCell$FreeCellRules$StandardBoard
};
...
function OldFreeCell$TwoDeck$Board(props) {
  var setRef = props.setRef;
  return JsxRuntime.jsxs(React.Fragment, {
              children: [
                JsxRuntime.jsxs("div", {
...
var Board = {
  make: OldFreeCell$TwoDeck$Board
};
