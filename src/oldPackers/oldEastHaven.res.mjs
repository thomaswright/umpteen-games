  ...
  return {
          ...
          droppedUpon: (function (game, dragPile) {
              ...
              if (isLast && Card.rankIsAbove(card, dragPileBase) && Card.color(dragPileBase) !== Card.color(card)) {
                return {
                        piles: flipLastUp$1(game.piles.map(function (stack) {
  ...
  return {
          ...
          onClick: (function (game) {
              return Core__Option.map(Common.ArrayAux.getLast(game.stock), (function (stockGroup) {
                            return {
                                    piles: flipLastUp$1(game.piles.map(function (pile, i) {
...
function OldEastHaven$EastHavenRules$StandardBoard(props) {
...
var StandardBoard = {
  make: OldEastHaven$EastHavenRules$StandardBoard
};

function OldEastHaven$EastHavenRules$AllCards(props) {
...
var AllCards = {
  make: OldEastHaven$EastHavenRules$AllCards
};
