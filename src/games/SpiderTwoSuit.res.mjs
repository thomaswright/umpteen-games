...
function SpiderTwoSuit$GameRules$Board(props) {
...
var Board = {
  make: SpiderTwoSuit$GameRules$Board
};

function SpiderTwoSuit$GameRules$AllCards(props) {
...
var AllCards = {
  make: SpiderTwoSuit$GameRules$AllCards
};
